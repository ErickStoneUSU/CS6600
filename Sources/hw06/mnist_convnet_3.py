...
# always using stride of 1
# dim = [(width - filter_dim)/stride + 1,
#        (width - filter_dim)/stride + 1,
#        filter_num]
# size = dim * dim * dim
# params = (filter_dim * filter_dim + 1) * filter_num
# dim       || size         || # params
# 28,28,1   || 784          || 0
# 24,24,20  || 11,520       || 520
#
...
def build_tflearn_convnet_3():
    network = regression(components_3(), optimizer='sgd', loss='categorical_crossentropy', learning_rate=0.01)
