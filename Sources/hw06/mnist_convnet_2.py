...
def components_2():
    ...
    conv_layer_2 = conv_2d(pool_layer_1, nb_filter=20, filter_size=3, activation='relu', name='conv_layer_2')
    ...
    fc_layer_2 = fully_connected(fc_layer_1, 23, activation='softmax', name='fc_layer_2')
    fc_layer_3 = fully_connected(fc_layer_2, 10, activation='softmax', name='fc_layer_3')
    return fc_layer_3
