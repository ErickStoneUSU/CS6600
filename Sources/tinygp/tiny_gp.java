 ...
 * This is roughly 2200 operations and values. So, I set
 * the popsize to 3000. Still no success. And this was with
 * 1000 generations.
 * At this time, I noticed the fitness was decreasing. It was around
 * 11 and getting smaller each generation incredibly slowly though.
 * Experimenting with crossover prob showed a better fit when high.
...
//    print_indiv( pop[best], 0 );
  ...
  public static void main(String[] args) {
    String fname = "Sources/tinygp/problem.dat";
    long s = -1;
