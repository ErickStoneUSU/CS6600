...
(defparameter *banana-ops*
  (list
      ...
      (make-op :action 'move-chair
         :preconds '(empty-handed)
         :add-list '(chair-in-middle-of-room)
         :del-list '(chair-at-door at-door))
      (make-op :action 'climb-on-chair
         :preconds '(chair-in-middle-of-room empty-handed)
         :add-list '(on-chair)
         :del-list '(on-floor))
      (make-op :action 'reach-bananas
         :preconds '(chair-in-middle-of-room on-chair)
         :add-list '(reach-bananas))
      (make-op :action 'grasp-bananas
  	     :preconds '(reach-bananas empty-handed)
  	     :add-list '(have-bananas))
      (make-op :action 'eat-bananas
         :preconds '(have-bananas)
         :add-list '(not-hungry)
         :del-list '(hungry))
  ))
